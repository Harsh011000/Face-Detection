...
To store the iamge vectors in db provide the image as 'sample.jpg' in root directory and run the push_data.py file
Install all requirements specified in requirements.txt